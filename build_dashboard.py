...
<aside class="rail">
  ...
  <div class="rail-meta">
    <div class="lbl">Agricultural HH (analytic frame)</div>
    ...
    <div class="row" style="margin-top:6px;border-top:1px dashed var(--line);padding-top:6px;font-size:11px"><span>BIHS panel size</span><span>5,503 to 6,715</span></div>
  </div>
  <div class="rail-foot">
...
<section id="t-map" class="tab on">
  ...
  <p class="note">Denominator: agricultural households (cultivated land or operated a pond in the recall period), weighted with each round's BIHS sampling weights. Analytic-frame sizes are 3,755 / 3,723 / 3,220 / 2,924 households; the underlying BIHS panel ran 5,503 to 6,715 households per round. Frame definitions follow the SPIA Bangladesh Study 2025; see the 2024 SPIA round tab for the full citation.</p>
  <div class="controls">
